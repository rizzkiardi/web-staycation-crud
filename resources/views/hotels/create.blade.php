    ...
    <form action="{{ route('hotels.store') }}" method="POST" enctype="multipart/form-data" >
        ...
        <div class="shadow-md bg-white p-5 rounded-base border-2 border-default-medium">
            ...
            <div class="mb-4">
                ...
                <textarea name="location" value="{{ old('location') }}" id="location" rows="4" class="bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full p-3.5 shadow-xs placeholder:text-body" placeholder="Write your location here..."></textarea>
                @error('location')
                    <span class="text-red-500 italic invalid-feedback">{{ $message }}</span>
                @enderror
            </div>
